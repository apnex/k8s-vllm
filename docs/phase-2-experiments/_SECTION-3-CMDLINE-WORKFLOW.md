...
```bash
sudo /root/k8s-vllm/tools/get-pci-stats.sh --baseline E<NN>
```
...
```bash
sudo /root/k8s-vllm/tools/get-pci-stats.sh --snapshot E<NN>
sudo /root/k8s-vllm/tools/get-pci-stats.sh --diff E<NN>
```
