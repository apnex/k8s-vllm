...
sudo /root/k8s-vllm/tools/get-pci-stats.sh --baseline E08-quiesced
# Verify quiesce
...
```bash
sleep 15
sudo /root/k8s-vllm/tools/get-pci-stats.sh --snapshot E08-quiesced
sudo /root/k8s-vllm/tools/get-pci-stats.sh --diff E08-quiesced
