...
sudo /root/k8s-vllm/tools/get-pci-stats.sh --baseline E25-cold-control

# Phase B: enter broken-BAR1 state, capture
sudo /root/k8s-vllm/tools/get-pci-stats.sh --snapshot E25
sudo /root/k8s-vllm/tools/get-pci-stats.sh --diff E25
```
...
**Status:** BLOCKED — kernel build env not yet established
