...
sudo /root/k8s-vllm/tools/get-pci-stats.sh --baseline E13-$METHOD
```
...
```bash
sudo /root/k8s-vllm/tools/get-pci-stats.sh --snapshot E13-$METHOD
sudo /root/k8s-vllm/tools/get-pci-stats.sh --diff E13-$METHOD
```
...
| Method | Status | Date | Diff highlights |
|---|---|---|---|
| flr | | | (matches E12) |
| pm | | | |
| bus | | | |
