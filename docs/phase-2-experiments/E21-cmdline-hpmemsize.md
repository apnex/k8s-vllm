...
```bash
sudo /root/k8s-vllm/tools/get-pci-stats.sh --baseline E21-cold-control
# enter broken-BAR1 state per recipe
sudo /root/k8s-vllm/tools/get-pci-stats.sh --snapshot E21
sudo /root/k8s-vllm/tools/get-pci-stats.sh --diff E21
```
