...
**Strategic context:** `docs/phase-2-archaeology-matrix.md` (matrix doc — what, why, what order)
**Mission context:** `docs/mission-egpu-hot-plug-hot-power.md` (MISSION-1 root doc)
**State-capture tool:** `tools/get-pci-stats.sh` (used by every experiment)
...
| ID | File | Status |
|---|---|---|
| E18 | [`pci=realloc=on` alone](E18-cmdline-realloc-on.md) | PENDING |
