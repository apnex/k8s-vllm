...
sudo /root/k8s-vllm/tools/get-pci-stats.sh --baseline E24-<variant>-cold

# Phase B: runtime cable cycle
# (enter broken-BAR1 state per recipe)
sudo /root/k8s-vllm/tools/get-pci-stats.sh --snapshot E24-<variant>
sudo /root/k8s-vllm/tools/get-pci-stats.sh --diff E24-<variant>
```
