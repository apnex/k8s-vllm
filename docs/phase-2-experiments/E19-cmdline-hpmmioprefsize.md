...
```bash
sudo /root/k8s-vllm/tools/get-pci-stats.sh --baseline E19-cold-control
...
sudo /root/k8s-vllm/tools/get-pci-stats.sh --snapshot E19
sudo /root/k8s-vllm/tools/get-pci-stats.sh --diff E19
```
